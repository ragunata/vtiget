<?php /* Smarty version Smarty-3.1.7, created on 2017-09-19 13:15:18
         compiled from "/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:118459456159c1186607e6d1-95895212%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdfb355d150a9f78c3f13955701140ed806501ca' => 
    array (
      0 => '/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Settings/Profiles/EditView.tpl',
      1 => 1398442051,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118459456159c1186607e6d1-95895212',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59c1186632fab',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59c1186632fab')) {function content_59c1186632fab($_smarty_tpl) {?>
...
</strong></label></div><table class="table table-bordered"><?php $_smarty_tpl->tpl_vars['UTILITY_ACTION_COUNT'] = new Smarty_variable(0, null, 0);?><?php $_smarty_tpl->tpl_vars["ALL_UTILITY_ACTIONS_ARRAY"] = new Smarty_variable(array(), null, 0);?><?php  $_smarty_tpl->tpl_vars['ACTION_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ACTION_MODEL']->_loop = false;
...
]" <?php if ($_smarty_tpl->tpl_vars['RECORD_MODEL']->value->hasModuleActionPermission($_smarty_tpl->tpl_vars['PROFILE_MODULE']->value,$_smarty_tpl->tpl_vars['ACTIONID']->value)){?>checked="true" <?php }elseif(empty($_smarty_tpl->tpl_vars['RECORD_ID']->value)&&empty($_smarty_tpl->tpl_vars['IS_DUPLICATE_RECORD']->value)){?> checked="true" <?php }?>> <?php echo $_smarty_tpl->tpl_vars['ACTION_MODEL']->value->getName();?>
</td><?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['last']||($_smarty_tpl->getVariable('smarty')->value['foreach']['actions']['index']+1)%3==0){?></div><?php }?><?php } ?></table></div></td></tr><?php }?><?php } ?></tbody></table></div></div><br><div class="pull-right"><button class="btn btn-success" type="submit"><strong><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</strong></button><a class="cancelLink" onclick="javascript:window.history.back();" type="reset">Cancel</a><br><br></div></form></div><?php }} ?>