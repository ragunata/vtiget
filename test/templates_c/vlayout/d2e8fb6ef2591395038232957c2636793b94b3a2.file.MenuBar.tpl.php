<?php /* Smarty version Smarty-3.1.7, created on 2017-09-21 05:59:31
         compiled from "/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:96016001359bf4f47bb9283-54790368%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd2e8fb6ef2591395038232957c2636793b94b3a2' => 
    array (
      0 => '/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Vtiger/MenuBar.tpl',
      1 => 1505973567,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '96016001359bf4f47bb9283-54790368',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59bf4f47e29d1',
  'variables' => 
  array (
    'MENU_STRUCTURE' => 0,
    'moreMenus' => 0,
...
</a></div><?php }?></div></li></ul></div><!-- <?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 echo $combo;  <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<select class="chzn-select chzn-done" id="basicSearchModulesList" style="width: 150px;"><option value="" class="globalSearch_module_All">All Records</option><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 echo count($data); foreach($data as $val): <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<option value="23" class="globalSearch_module_All">tets</option><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 endforeach; <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</select> --><!-- <select class="chzn-select chzn-done" id="basicSearchModulesList" style="width: 150px;"><option value="" class="globalSearch_module_All">All Records</option><option value="Contacts" class="globalSearch_module_Contacts">Borrowers</option><option value="Accounts" class="globalSearch_module_Accounts">Organizations</option><option value="Documents" class="globalSearch_module_Documents">Documents</option></select> --><div class="span4 marginLeftZero pull-right" id="headerLinks"><!-- Status Update --><?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
include('own_config.php');session_start();$id= $_SESSION['authenticated_user_id'];$usersResult = $mysqli->query("select vtiger_users.*, b.* from `vtiger_users`Join `vtiger_user2role` AS b on vtiger_users.id = b.userid where vtiger_users.id = $id limit 1") or die(mysql_error());$row1 = mysqli_fetch_array($usersResult);$status_id = $row1['user_status'];$status_val = $row1['user_status_val'];$roleid = $row1['roleid'];$active= '';if(isset($_SESSION['authenticated_user_status'])){$active= 'yes';}if($roleid == 'H9'){$data = array();$result = $mysqli->query("select * from vtiger_user_status");$data = array();$i = 1;$combo = '<select class="chzn-select chzn-done" id="onlineStatusUpdate" style="width: 150px; margin: 0;">';while($row = mysqli_fetch_array($result)){$data[$i]['name'] = $row['status'];$name = $row['status'];$data[$i]['id'] = $row['statusid'];$id = $row['statusid'];if( (($status_id.'#'.$status_val) == ($id.'#'.$name)) && !empty($active)  ){$combo .= '<option value="'.$id.'#'.$name.'" selected>'.$name.'</option>';}else{$combo .= '<option value="'.$id.'#'.$name.'">'.$name.'</option>';}$i++;}$combo .= '</select>';echo $combo;}<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
<span id="headerLinksBig" class="pull-right headerLinksContainer"><!-- <span class="dropdown span settingIcons"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><img src="<?php echo vimage_path('theme_brush.png');?>
...
" /></a><?php }?><?php }else{ ?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('first_name'), null, 0);?><?php if (empty($_smarty_tpl->tpl_vars['title']->value)){?><?php $_smarty_tpl->tpl_vars['title'] = new Smarty_variable($_smarty_tpl->tpl_vars['USER_MODEL']->value->get('last_name'), null, 0);?><?php }?><span class="dropdown-toggle" data-toggle="dropdown" href="#"><a id="menubar_item_right_<?php echo $_smarty_tpl->tpl_vars['title']->value;?>
...
var active = "<?php $_smarty_tpl->smarty->_tag_stack[] = array('php', array()); $_block_repeat=true; echo smarty_php_tag(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
 echo $_SESSION['authenticated_user_status']; <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_php_tag(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
";
if(!active){
