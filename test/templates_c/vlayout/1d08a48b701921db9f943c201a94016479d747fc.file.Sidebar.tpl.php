<?php /* Smarty version Smarty-3.1.7, created on 2017-09-19 13:10:11
         compiled from "/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Settings/Vtiger/Sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186250275659bf4f47ec1b16-76945833%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d08a48b701921db9f943c201a94016479d747fc' => 
    array (
      0 => '/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Settings/Vtiger/Sidebar.tpl',
      1 => 1505826371,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186250275659bf4f47ec1b16-76945833',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_59bf4f47f379f',
  'variables' => 
  array (
    'QUALIFIED_MODULE' => 0,
    'SETTINGS_MENUS' => 0,
...
<?php if ($_valid && !is_callable('content_59bf4f47f379f')) {function content_59bf4f47f379f($_smarty_tpl) {?>
...
?><?php if (($_smarty_tpl->tpl_vars['USER_ROLE']->value=='H2')||($_smarty_tpl->tpl_vars['USER_ROLE']->value!='H2'&&$_smarty_tpl->tpl_vars['MENU']->value->getLabel()=='LBL_USER_MANAGEMENT')){?><div class="quickWidget"><div class="accordion-heading accordion-toggle quickWidgetHeader" data-parent="#settingsQuickWidgetContainer" data-target="#Settings_sideBar_<?php echo Vtiger_Util_Helper::replaceSpaceWithUnderScores($_smarty_tpl->tpl_vars['MENU']->value->getLabel());?>
...
?><?php if (($_smarty_tpl->tpl_vars['USER_ROLE']->value=='H2')||($_smarty_tpl->tpl_vars['USER_ROLE']->value!='H2'&&$_smarty_tpl->tpl_vars['MENUITEM']->value->get('name')=='LBL_USERS')){?><div class="<?php if ($_smarty_tpl->tpl_vars['MENUITEM']->value->getId()==$_smarty_tpl->tpl_vars['SELECTED_FIELDID']->value){?> selectedMenuItem selectedListItem<?php }?>" style="padding:7px;border-top:0px;"><div class="row-fluid menuItem"  data-actionurl="<?php echo $_smarty_tpl->tpl_vars['MENUITEM']->value->getPinUnpinActionUrl();?>
...
" data-action="pin" <?php }?> /><div class="clearfix"></div></div></div><?php }?><?php } ?></div></div><?php }?><?php } ?></div><div class="row-fluid"><button type="button" class="row-fluid extensionStorebtn" onclick='window.location.href="index.php?module=ExtensionStore&parent=Settings&view=ExtensionStore"'><?php echo vtranslate('LBL_EXTENSION_STORE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
</button></div>
<?php }} ?>