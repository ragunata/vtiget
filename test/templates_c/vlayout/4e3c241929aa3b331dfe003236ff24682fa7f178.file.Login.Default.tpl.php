<?php /* Smarty version Smarty-3.1.7, created on 2017-09-18 05:28:59
         compiled from "/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Users/Login.Default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:129224058459bf599b915d45-38752713%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e3c241929aa3b331dfe003236ff24682fa7f178' => 
    array (
      0 => '/var/www/html/ptpk/includes/runtime/../../layouts/vlayout/modules/Users/Login.Default.tpl',
      1 => 1504788880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '129224058459bf599b915d45-38752713',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59bf599b9781d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59bf599b9781d')) {function content_59bf599b9781d($_smarty_tpl) {?>
...
</a></div></div><div class="span9"><!-- <div class="helpLinks"><a href="https://www.vtiger.com">` Website</a> |<a href="https://wiki.vtiger.com/vtiger6/">Vtiger Wiki</a> |<a href="https://www.vtiger.com/crm/videos/">Vtiger videos </a> |<a href="https://discussions.vtiger.com/">Vtiger Forums</a></div><div class="helpLinks sign-up" id="forgotPassword"><p class="color-white">Not a customer?</p><button type="submit" class="btn btn-primary sbutton">Sign Up</button></div> --></div></div><div class="row-fluid"><div class="span12"><div class="content-wrapper"><div class="container-fluid"><div class="row-fluid"><!-- <div class="span6"><div class="carousal-container"><div><h2> Get more out of Vtiger </h2></div><ul class="bxslider"><li><div id="slide01" class="slide"><img class="pull-left" src="<?php echo vimage_path('android_text.png');?>
...
"/></div></li></ul></div></div> --><div class="offset4 span4"><div class=""><div class="" id="loginDiv"><div class=""><h3 class="color-white">PTPK CRM Login</h3></div><form class="form-horizontal login-form" style="margin:0;" action="index.php?module=Users&action=Login" method="POST"><?php if (isset($_REQUEST['error'])){?><div class="alert alert-error"><p>Invalid username or password.</p></div><?php }?><?php if (isset($_REQUEST['fpError'])){?><div class="alert alert-error"><p>Invalid Username or Email address.</p></div><?php }?><?php if (isset($_REQUEST['status'])){?><div class="alert alert-success"><p>Mail has been sent to your inbox, please check your e-mail.</p></div><?php }?><?php if (isset($_REQUEST['statusError'])){?><div class="alert alert-error"><p>Outgoing mail server was not configured.</p></div><?php }?><div class="control-group"><!-- <label class="control-label" for="username"><b>User name</b></label> --><div class="ptpk-sec-username"><input type="text" id="username" class="form-control" name="username" placeholder="Username" value="admin"></div></div><div class="control-group"><!-- <label class="control-label" for="password"><b>Password</b></label> --><div class="ptpk-sec-password"><input type="password" class="form-control" id="password" name="password" placeholder="Password" value="admin"><div class="control-group"><div class="" id="forgotPassword"><a href="javascript:void(0)" id="forgotPassword">?</a></div></div></div></div><div class="control-group signin-button"><div class="" id="forgotPassword"><button type="submit" class="btn btn-primary btn-block sbutton">Login</button><!-- &nbsp;&nbsp;&nbsp;<a>Forgot Password ?</a> --></div></div><img src='//stats.vtiger.com/stats.php?uid=<?php echo $_smarty_tpl->tpl_vars['APPUNIQUEKEY']->value;?>
