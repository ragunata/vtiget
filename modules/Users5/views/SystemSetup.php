...
class Users5_SystemSetup_View extends Vtiger_Index_View {
	...
	// 	$userModel = Users5_Record_Model::getCurrentUserModel();
	// 	$isFirstUser = Users5_CRMSetup::isFirstUser($userModel);
		
	// 	if($isFirstUser) {
	// 		$viewer->assign('IS_FIRST_USER', $isFirstUser);
	// 		$viewer->assign('PACKAGES_LIST', Users5_CRMSetup::getPackagesList());
