...
class Users5_PreferenceDetail_View extends Vtiger_Detail_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$dayStartPicklistValues = Users5_Record_Model::getDayStartsPicklistValues($recordStructureInstance->getStructure());
