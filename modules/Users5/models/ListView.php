...
class Users5_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getAdvancedLinks(){
		...
		$createPermission = Users5_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView');
		$advancedLinks = array();
		$importPermission = Users5_Privileges_Model::isPermitted($moduleModel->getName(), 'Import');
		if($importPermission && $createPermission) {
                    $advancedLinks[] = array(
                        'linktype' => 'LISTVIEW',
                        'linklabel' => 'LBL_EXPORT',
                        'linkurl' => 'javascript:Settings_Users5_List_Js.triggerExportAction()',
                        'linkicon' => ''
                    );
		}
