...
class Users5_Record_Model extends Vtiger_Record_Model {
	 ...
	 * @return Users5_Record_Model instance
	 */
	 ...
	 * @return <Array> - List of Users5_Record_Model instances
	 */
	...
	function getSubordinateUsers() {
		...
		if(empty($privilegesModel)) {
			$privilegesModel = Users5_Privileges_Model::getInstanceById($this->getId());
	 ...
	 * @param <String> $module
	 * @return <Array of Users5_Record_Model>
	 */
	public function getAccessibleUsersForModule($module) {
		$currentUser = Users5_Record_Model::getCurrentUserModel();
		$curentUserPrivileges = Users5_Privileges_Model::getCurrentUserPrivilegesModel();
	...
	public function getImageDetails() {
		$currentUserModel = Users5_Record_Model::getCurrentUserModel();
		$db = PearDatabase::getInstance();
	...
	public static function getInstanceByName($userName) {
		...
		if ($db->num_rows($result)) {
			return Users5_Record_Model::getInstanceById($db->query_result($result, 0, 'id'), 'Users');
		}
		return false;
	}
