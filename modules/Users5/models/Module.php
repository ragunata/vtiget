...
class Users5_Module_Model extends Vtiger_Module_Model {
	/**
   ...
   /**
	...
	public function saveLogoutHistory(){
		...
		$userRecordModel = Users5_Record_Model::getCurrentUserModel();
		$userIPAddress = $_SERVER['REMOTE_ADDR'];
	...
	public static function savePackagesInfo($packagesList) {
		$adb = PearDatabase::getInstance();
		$packagesListFromDB = Users5_CRMSetup::getPackagesList();
