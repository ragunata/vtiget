...
class Users4_PreferenceDetail_View extends Vtiger_Detail_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$dayStartPicklistValues = Users4_Record_Model::getDayStartsPicklistValues($recordStructureInstance->getStructure());
