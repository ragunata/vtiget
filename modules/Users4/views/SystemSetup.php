...
class Users4_SystemSetup_View extends Vtiger_Index_View {
	...
	// 	$userModel = Users4_Record_Model::getCurrentUserModel();
	// 	$isFirstUser = Users4_CRMSetup::isFirstUser($userModel);
		
	// 	if($isFirstUser) {
	// 		$viewer->assign('IS_FIRST_USER', $isFirstUser);
	// 		$viewer->assign('PACKAGES_LIST', Users4_CRMSetup::getPackagesList());
