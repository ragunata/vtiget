...
class Users4_Module_Model extends Vtiger_Module_Model {
	/**
   ...
   /**
	...
	public function saveLogoutHistory(){
		...
		$userRecordModel = Users4_Record_Model::getCurrentUserModel();
		$userIPAddress = $_SERVER['REMOTE_ADDR'];
	...
	public static function savePackagesInfo($packagesList) {
		$adb = PearDatabase::getInstance();
		$packagesListFromDB = Users4_CRMSetup::getPackagesList();
