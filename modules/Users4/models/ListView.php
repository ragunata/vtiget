...
class Users4_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getAdvancedLinks(){
		...
		$createPermission = Users4_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView');
		$advancedLinks = array();
		$importPermission = Users4_Privileges_Model::isPermitted($moduleModel->getName(), 'Import');
		if($importPermission && $createPermission) {
                    $advancedLinks[] = array(
                        'linktype' => 'LISTVIEW',
                        'linklabel' => 'LBL_EXPORT',
                        'linkurl' => 'javascript:Settings_Users4_List_Js.triggerExportAction()',
                        'linkicon' => ''
                    );
		}
