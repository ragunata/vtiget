...
class Users3_Record_Model extends Vtiger_Record_Model {
	 ...
	 * @return Users3_Record_Model instance
	 */
	 ...
	 * @return <Array> - List of Users3_Record_Model instances
	 */
	...
	function getSubordinateUsers() {
		...
		if(empty($privilegesModel)) {
			$privilegesModel = Users3_Privileges_Model::getInstanceById($this->getId());
	 ...
	 * @param <String> $module
	 * @return <Array of Users3_Record_Model>
	 */
	public function getAccessibleUsersForModule($module) {
		$currentUser = Users3_Record_Model::getCurrentUserModel();
		$curentUserPrivileges = Users3_Privileges_Model::getCurrentUserPrivilegesModel();
	...
	public static function getInstanceByName($userName) {
		...
		if ($db->num_rows($result)) {
			return Users3_Record_Model::getInstanceById($db->query_result($result, 0, 'id'), 'Users');
		}
		return false;
	}
