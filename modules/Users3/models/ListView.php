...
class Users3_ListView_Model extends Vtiger_ListView_Model {
	...
	public function getAdvancedLinks(){
		...
		$createPermission = Users3_Privileges_Model::isPermitted($moduleModel->getName(), 'EditView');
		$advancedLinks = array();
		$importPermission = Users3_Privileges_Model::isPermitted($moduleModel->getName(), 'Import');
		if($importPermission && $createPermission) {
                    $advancedLinks[] = array(
                        'linktype' => 'LISTVIEW',
                        'linklabel' => 'LBL_EXPORT',
                        'linkurl' => 'javascript:Settings_Users3_List_Js.triggerExportAction()',
                        'linkicon' => ''
                    );
		}
