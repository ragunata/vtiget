...
class Users3_Module_Model extends Vtiger_Module_Model {
	/**
   ...
   /**
	...
	public function saveLogoutHistory(){
		...
		$userRecordModel = Users3_Record_Model::getCurrentUserModel();
		$userIPAddress = $_SERVER['REMOTE_ADDR'];
	...
	public static function savePackagesInfo($packagesList) {
		$adb = PearDatabase::getInstance();
		$packagesListFromDB = Users3_CRMSetup::getPackagesList();
