...
class Users3_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function userExists(Vtiger_Request $request){
		...
		$userModuleModel = Users3_Module_Model::getCleanInstance($module);
	...
	public function savePassword(Vtiger_Request $request) {
        ...
        public function restoreUser(Vtiger_Request $request) {
                ...
                $recordModel = Users3_Record_Model::getInstanceById($record, $moduleName);
                ...
                $userModuleModel = Users3_Module_Model::getInstance($moduleName);
