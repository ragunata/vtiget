...
class Users3_ChangePassword_View extends Vtiger_Basic_View {
    ...
    public function preProcess (Vtiger_Request $request, $display=true) {
		...
		if(!empty($moduleName)) {
			...
			$userPrivilegesModel = Users3_Privileges_Model::getInstanceById($currentUser->getId());
		...
		$viewer->assign('CURRENT_USER_MODEL', Users3_Record_Model::getCurrentUserModel());
