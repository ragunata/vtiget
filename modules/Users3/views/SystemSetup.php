...
class Users3_SystemSetup_View extends Vtiger_Index_View {
	...
	// 	$userModel = Users3_Record_Model::getCurrentUserModel();
	// 	$isFirstUser = Users3_CRMSetup::isFirstUser($userModel);
		
	// 	if($isFirstUser) {
	// 		$viewer->assign('IS_FIRST_USER', $isFirstUser);
	// 		$viewer->assign('PACKAGES_LIST', Users3_CRMSetup::getPackagesList());
