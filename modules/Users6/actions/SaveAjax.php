...
class Users6_SaveAjax_Action extends Vtiger_SaveAjax_Action {
	...
	public function userExists(Vtiger_Request $request){
		...
		$userModuleModel = Users6_Module_Model::getCleanInstance($module);
	...
	public function savePassword(Vtiger_Request $request) {
        ...
        public function restoreUser(Vtiger_Request $request) {
                ...
                $recordModel = Users6_Record_Model::getInstanceById($record, $moduleName);
