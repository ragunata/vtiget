...
class Users6_ForgotPassword_Action {
    ...
    public function changePassword($request) {
        ...
        if ($valid) {
            ...
            $user = Users6::getActiveAdminUser();
            $wsUserId = vtws_getWebserviceEntityId('Users6', $userId);
        ...
        $viewer->view('FPLogin.tpl', 'Users6');
    }
...
Users6_ForgotPassword_Action::run($_REQUEST);
