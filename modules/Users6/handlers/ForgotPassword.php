...
class Users6_ForgotPassword_Handler {
    ...
    public function changePassword($data) {
        ...
        $changePasswordTrackUrl = $site_URL . "/modules/Users6/actions/ForgotPassword.php";
        ...
        if ($expiryTime > $currentTime) {
            ...
            $options = array(
                'handler_path' => 'modules/Users6/handlers/ForgotPassword.php',
                'handler_class' => 'Users6_ForgotPassword_Handler',
