...
class Users6_PreferenceDetail_View extends Vtiger_Detail_View {
	...
	public function process(Vtiger_Request $request) {
		...
		$dayStartPicklistValues = Users6_Record_Model::getDayStartsPicklistValues($recordStructureInstance->getStructure());
    ...
    public function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
                        "modules.Users6.resources.Detail",
