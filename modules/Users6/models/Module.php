...
class Users6_Module_Model extends Vtiger_Module_Model {
	/**
	...
	public function getQueryByModuleField($sourceModule, $field, $record, $listQuery) {
		if($sourceModule == 'Users6' && $field == 'reports_to_id') {
	...
	public function searchRecord($searchValue, $parentId=false, $parentModule=false, $relatedModule=false) {
		if(!empty($searchValue)) {
			...
			for($i=0; $i<$noOfRows; ++$i) {
				...
				$modelClassName = Vtiger_Loader::getComponentClassName('Model', 'Record', 'Users6');
				$recordInstance = new $modelClassName();
				$matchingRecords['Users6'][$row['id']] = $recordInstance->setData($row)->setModuleFromInstance($this);
			}
   ...
   /**
	...
	public static function savePackagesInfo($packagesList) {
		$adb = PearDatabase::getInstance();
		$packagesListFromDB = Users6_CRMSetup::getPackagesList();
