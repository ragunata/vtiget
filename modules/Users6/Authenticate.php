 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/vtiger_crm/sugarcrm/modules/Users6/Authenticate.php,v 1.10 2005/02/28 05:25:22 jack Exp $
...
if($focus->is_authenticated()) {
	...
	if($audit_trail == 'true') {
		...
		$params = array($adb->getUniqueID('vtiger_audit_trial'), $focus->id, 'Users6','Authenticate','',$date_var);
		$adb->pquery($query, $params);
	}

	require_once('modules/Users6/LoginHistory.php');
	...
	$userSetupStatus = Users6_CRMSetup::getUserSetupStatus($focus->id);
	if ($userSetupStatus) {
		$user = $focus->retrieve_entity_info($focus->id, 'Users6');
		$isFirstUser = Users6_CRMSetup::isFirstUser($user);
		if($isFirstUser) {
			header('Location: index.php?module=Users6&action=SystemSetup');
		} else {
