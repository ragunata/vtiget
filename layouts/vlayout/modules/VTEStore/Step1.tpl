    ...
    <div class="workFlowContents" style="padding-left: 3%;padding-right: 3%">
        <div class="padding1per" style="border:1px solid #ccc;">
            ...
            <div class="control-group" style="text-align: center;">
                {if $SOAPENABLE==1 && $IONCUBELOADED==1}<button id="UpgradeVTEStore" class="btn btn-success UpgradeVTEStore">{vtranslate('LBL_INSTALL', 'VTEStore')}</button>{/if}
            </div>
            {if $SOAPENABLE==1 && $IONCUBELOADED==1}
