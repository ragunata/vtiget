...
Settings_Vtiger_List_Js("Settings_Users6_List_Js",{
				...
				function(data){
					if(data){
						...
						params.onValidationComplete = function(form, valid){
							if(valid){
								Settings_Users6_List_Js.deleteUser(form)
							}
							return false;
						}
	...
	deleteUser: function (form){
        ...
        triggerExportAction: function() {
            ...
            var newForm = jQuery('<form>', {
                'method': 'post',
                'action': siteUrl[0] + '?module=Users6&source_module=Users6&action=ExportData',
            }).append(jQuery('<input>', {
                'name': csrfMagicName,
	...
	registerDeleteRecordClickEvent: function(){
		...
		listViewContentDiv.on('click','.deleteRecordButton',function(e){
			...
			Settings_Users6_List_Js.deleteRecord(deleteActionUrl);
			e.stopPropagation();
		});
	},
        
        /*
         *Function to filter Active and Inactive users from Users6 List View
         */
