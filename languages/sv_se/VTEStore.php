...
$languageStrings = array(
    ...
    'It is recommended to have php.ini values set as above.' => 'It is recommended to have php.ini values set as above. If you experience any issues such as:<br><br>
                        ...
                        - Extension partially installed. Erros include "Permission Denied", "Access Denied".<br>
                        - You are required to enter a license after extension has been installed.<br>
                        - You are getting an error e.g "Internal Server Error 500", or any other error page after install<br><br>

                        Please update your php.ini values are recommeneded to avoid issues explained above.<br><br>

                        <a href="https://www.vtexperts.com/premium-extension-pack-php-ini-requirements/" target="_blank">Click here for instructions.</a><br><br>

                        You can also contact us and we\'ll assist with this at no charge.<br>

                        *Email: help@vtexperts.com<br>
                        *Phone: +1 (818) 495-5557<br>
                        *Chat: Available on <a href="https://www.vtexperts.com/" target="_blank">http://www.VTExperts.com</a><br>',
